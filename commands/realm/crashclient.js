...
// Helper: asynchronous file existence check
...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("clientexplode")
    .setIntegrationTypes(0, 1)
    .setContexts(0, 1, 2)
    .setDescription("Explode every user on the Realm")
  ...
  async execute(interaction) {
    ...
    try {
      ...
      try {
        ...
        // If whitelist fails to load, assume an empty list
      }
      ...
      client.on('start_game', async () => {
        ...
        try {
          ...
          // Start spamming text after joining
          let intervalId;
          setTimeout(() => {
